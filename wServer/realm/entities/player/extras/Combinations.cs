...
namespace wServer.realm.entities.player
{
    public class Combinations
    {
        ...
        {
            // ---- ADVANCED COMBOS ---- //
            AddAdvCombo("Robe of the Sphinx", 12000, "Robe of the Ancient Intellect", "Robe of the Star Mother",
            ...
            AddCombo("Potion of Oryx", 10, "Potion of Dexterity", "Potion of Speed", "Potion of Wisdom",
                "Potion of Vitality", "Potion of Defense", "Potion of Attack", "Potion of Life", "Potion of Mana");
