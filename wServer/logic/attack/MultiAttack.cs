...
{
    internal class MultiAttack : Behavior
    {
        private static readonly Dictionary<Tuple<float, float, int, float, int>, MultiAttack> instances =
            new Dictionary<Tuple<float, float, int, float, int>, MultiAttack>();
        ...
        public static MultiAttack Instance(float radius, float angle, int numShot, float offset = 0,
