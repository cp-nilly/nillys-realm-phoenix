...
{
    internal class RingAttack : Behavior
    {
        private static readonly Dictionary<Tuple<int, float, float, int>, RingAttack> instances =
            new Dictionary<Tuple<int, float, float, int>, RingAttack>();
