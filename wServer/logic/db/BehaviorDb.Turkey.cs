                ...
                new RunBehaviors(
                    ...
                    IfEqual.Instance(-1, 1,
                        new RunBehaviors(
                            ...
                            new QueuedBehavior( //All the taunts
                                ...
                                //Unset invulnerable before the setkey is done.
                    ...
                    IfEqual.Instance(-1, 2,
                        new RunBehaviors(
                            ...
                            Cooldown.Instance(500, MultiAttack.Instance(25, 10*(float) Math.PI/180, 5, 0, 2)),
                            Cooldown.Instance(1000, MultiAttack.Instance(25, 10*(float) Math.PI/180, 3, 0, 3)),
                            Cooldown.Instance(500, MultiAttack.Instance(25, 10*(float) Math.PI/180, 4, 0, 5)),
                            Cooldown.Instance(1000, MultiAttack.Instance(25, 10*(float) Math.PI/180, 3, 0, 6)),
                            Cooldown.Instance(8000, Once.Instance(RingAttack.Instance(40, 0, 2, 7))),
                                    ...
                                    HpGreaterEqual.Instance(15000,
                                        new RunBehaviors(
                                            ...
                                            Cooldown.Instance(3600,
                                                MultiAttack.Instance(25, 45*(float) Math.PI/180, 10, 0, 1)),
                                            Cooldown.Instance(2000,
                                                PredictiveMultiAttack.Instance(25, 10*(float) Math.PI/180, 3, 5, 1)),
                                            SpawnMinion.Instance(0x2686, 2, 9, 12000, 12000),
                                            Once.Instance(SpawnMinionImmediate.Instance(0x2687, 7, 2, 3)),
                                            Cooldown.Instance(8000, Once.Instance(RingAttack.Instance(40, 0, 2, 7))),
                                            Cooldown.Instance(8000,
                                                Once.Instance(RingAttack.Instance(45, projectileIndex: 8)))
                                            )
                                        ),
                                    HpLesserPercent.Instance(0.2f,
                                        new RunBehaviors(
                                            ...
                                            Cooldown.Instance(2200,
                                                MultiAttack.Instance(25, 45*(float) Math.PI/180, 8, 0, 1)),
                                            Once.Instance(SetConditionEffect.Instance(ConditionEffectIndex.Invulnerable)),
                                            Cooldown.Instance(8000,
                                                Once.Instance(
                                                    UnsetConditionEffect.Instance(ConditionEffectIndex.Invulnerable))),
                            ...
                            Cooldown.Instance(20000,
                                new SimpleTaunt(
                                    "Happy Thanksgiving, Eat my meat! Only {HP} more mutton chunks for you to eat!"))
                            )
                        )
                    ),
