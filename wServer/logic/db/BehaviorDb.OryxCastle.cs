        ...
        private static _ Castle = Behav()
                ...
                new RunBehaviors(
                    ...
                    IfEqual.Instance(-1, 1,
                        new RunBehaviors(
                            ...
                            Cooldown.Instance(1500, RingAttack.Instance(12, 0, 0, 2)),
                        ...
                        new RunBehaviors(
                            ...
                            new QueuedBehavior(
                                ...
                                Cooldown.Instance(500,
                                    AngleMultiAttack.Instance((float) Math.PI, 21.25f*(float) Math.PI/360, 8, 1)),
                                AngleMultiAttack.Instance((float) Math.PI, 21.25f*(float) Math.PI/360, 8, 3),
                                Cooldown.Instance(500,
                                    AngleMultiAttack.Instance((float) Math.PI, 21.25f*(float) Math.PI/360, 8, 1)),
                                AngleMultiAttack.Instance((float) Math.PI, 21.25f*(float) Math.PI/360, 8, 3),
                                Cooldown.Instance(500,
                    ...
                    IfEqual.Instance(-1, 4,
                        new RunBehaviors(
                            ...
                            Cooldown.Instance(1000, RingAttack.Instance(12, 0, 0, 2)),
                            Cooldown.Instance(1800, MultiAttack.Instance(30, 25*(float) Math.PI/360, 6, 0, 1)),
                            new QueuedBehavior(
                                SetAltTexture.Instance(0),
                    ...
                    IfEqual.Instance(-1, 5,
                        new RunBehaviors(
                            ...
                            InfiniteSpiralAttack.Instance(500, 4, 20, 4),
                            InfiniteSpiralAttack.Instance(500, 4, -20, 4),
                            new QueuedBehavior(
                    ...
                    IfEqual.Instance(-1, 7,
                        new RunBehaviors(
                            TimedToggleTexture.Instance(1000, 3, 4),
                            TimedInfSpiralAttack.Instance(500, 250, 4, 45, 0, 4),
                            new QueuedBehavior(
                                AngleMove.Instance(12f, 90*(float) Math.PI/180, 13),
                    ...
                    IfEqual.Instance(-1, 8,
                        new RunBehaviors(
                            InfiniteSpiralAttack2.Instance(500, 1, -10, 270, 4),
                            InfiniteSpiralAttack2.Instance(500, 1, 10, 90, 4),
                            InfiniteSpiralAttack2.Instance(500, 1, -10, 270, 5),
                            InfiniteSpiralAttack2.Instance(500, 1, 10, 90, 5),
                            new QueuedBehavior(
                                SetAltTexture.Instance(0),
                ...
                new RunBehaviors(
                    ...
                    IfEqual.Instance(-1, 2,
                        new RunBehaviors(
                            ...
                            new QueuedBehavior(
                                AngleMove.Instance(12f, 90*(float) Math.PI/180, 13),
                                CooldownExact.Instance(2000),
                                Cooldown.Instance(500, AngleMultiAttack.Instance(0, 21.25f*(float) Math.PI/360, 8, 1)),
                                AngleMultiAttack.Instance(0, 21.25f*(float) Math.PI/360, 8, 3),
                                Cooldown.Instance(500, AngleMultiAttack.Instance(0, 21.25f*(float) Math.PI/360, 8, 1)),
                                AngleMultiAttack.Instance(0, 21.25f*(float) Math.PI/360, 8, 3),
                                Cooldown.Instance(500, AngleMultiAttack.Instance(0, 21.25f*(float) Math.PI/360, 8, 1)),
                                AngleMultiAttack.Instance(0, 21.25f*(float) Math.PI/360, 8, 3),
                    ...
                    IfEqual.Instance(-1, 4,
                        new RunBehaviors(
                            ...
                            InfiniteSpiralAttack.Instance(500, 4, 20, 4),
                            InfiniteSpiralAttack.Instance(500, 4, -20, 4),
                            Cooldown.Instance(400, PredictiveAttack.Instance(40, 5, 4)),
                            new QueuedBehavior(
                                CooldownExact.Instance(12001),
                                new SetKey(-1, 5)
                                )
                    ...
                    IfEqual.Instance(-1, 5,
                        new RunBehaviors(
                            SetConditionEffect.Instance(ConditionEffectIndex.Invulnerable),
                            Cooldown.Instance(1250, PredictiveRingAttack.Instance(30, 5, 50, 4)),
                            new QueuedBehavior(
                                SetAltTexture.Instance(0),
                                CooldownExact.Instance(12001),
                                new SetKey(-1, 6)
                    ...
                    IfEqual.Instance(-1, 7,
                        new RunBehaviors(
                            TimedToggleTexture.Instance(1000, 3, 4),
                            TimedInfSpiralAttack.Instance(250, 1000, 4, 45, 0, 4),
                            new QueuedBehavior(
                                AngleMove.Instance(12f, 90*(float) Math.PI/180, 13),
                                AngleMove.Instance(3.5f, 315*(float) Math.PI/180, 3),
                                AngleMove.Instance(3.5f, 45*(float) Math.PI/180, 3),
            ...
            .Init(0x0d82, Behaves("Oryx Brute",
                new RunBehaviors(
                    ...
                    Cooldown.Instance(12000,
                        If.Instance(IsEntityPresent.Instance(10, null), SpawnMinionImmediate.Instance(0x0d81, 1, 4, 4)))
                    ),
                loot: new LootBehavior(LootDef.Empty,
            ...
            .Init(0x0d7d, Behaves("Suit of Armor Spawner",
                new RunBehaviors(
                    ...
                    IfEqual.Instance(-1, 1,
                        new RunBehaviors(
                            Cooldown.Instance(2000,
                                If.Instance(IsEntityNotPresent.Instance(1, 0x0d7e), new SetKey(-1, 2)))
                            )
                        ),
                    IfEqual.Instance(-1, 2,
                        new RunBehaviors(
                    ...
                    IfEqual.Instance(-1, 1,
                        new RunBehaviors(
                            ...
                            Cooldown.Instance(450,
                                MultiAttack.Instance(12.5f, 30*(float) Math.PI/360, 3, 0, projectileIndex: 0)),
                    ...
                    IfEqual.Instance(-1, 3,
                        new RunBehaviors(
                            ...
                            Cooldown.Instance(350,
                                MultiAttack.Instance(12.5f, 30*(float) Math.PI/360, 4, 0, projectileIndex: 0)),
            ...
            .Init(0x0d7f, Behaves("Oryx Insect Commander",
                new RunBehaviors(
                    ...
                    If.Instance(EntityLesserThan.Instance(10, 10, 0x0d80),
                        SpawnMinionImmediate.Instance(0x0d80, 5, 4, 5))
                    ),
                loot: new LootBehavior(LootDef.Empty,
                    Tuple.Create(100, new LootDef(0, 5, 0, 2,
                        //Tuple.Create(0.1, (ILoot) new TierLoot(3, ItemType.Misc)
                ...
                new RunBehaviors(
                    ...
                    IfEqual.Instance(-1, 0,
                        new RunBehaviors(
                            ...
                            Cooldown.Instance(400,
                                MultiAttack.Instance(5, 45*(float) Math.PI/360, 3, 0, projectileIndex: 0)),
                    ...
                    IfEqual.Instance(-1, 1,
                        new RunBehaviors(
                            ...
                            Cooldown.Instance(400,
                                MultiAttack.Instance(6, 45*(float) Math.PI/360, 3, 0, projectileIndex: 0)),
                            Cooldown.Instance(400, RingAttack.Instance(10, 4, 0, 1)),
                ...
                new RunBehaviors(
                    ...
                    IfEqual.Instance(-1, 0,
                        new RunBehaviors(
                            ...
                            Cooldown.Instance(900,
                                MultiAttack.Instance(10, 20*(float) Math.PI/360, 6, 0, projectileIndex: 0)),
                            Cooldown.Instance(500, SimpleAttack.Instance(0, 1)),
                            Cooldown.Instance(1250, RingAttack.Instance(8, 6, 0, 2)),
                    ...
                    IfEqual.Instance(-1, 1,
                        new RunBehaviors(
                            ...
                            Cooldown.Instance(700, MultiAttack.Instance(10, 10*(float) Math.PI/360, 5, 0, 3)),
                            Cooldown.Instance(500, SimpleAttack.Instance(0, 1)),
                            Cooldown.Instance(1250, RingAttack.Instance(8, 6, 0, 2)),
                            Cooldown.Instance(7401,
                                If.Instance(IsEntityPresent.Instance(10, null),
                                    SpawnMinionImmediate.Instance(0x0d84, 1, 3, 4))),
