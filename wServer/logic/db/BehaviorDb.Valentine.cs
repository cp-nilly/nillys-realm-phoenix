...
namespace wServer.logic
{
    ...
    {
        private static _ Valentine = Behav()
                ...
                new RunBehaviors(
                    ...
                    IfEqual.Instance(-1, 2,
                        new RunBehaviors(
                            ...
                            Cooldown.Instance(1000,
                                MultiAttack.Instance(25, 45*(float) Math.PI/180, 5, 0, projectileIndex: 0)),
                            Cooldown.Instance(1000, MultiAttack.Instance(25, 45*(float) Math.PI/180, 3, 0, 1)),
                            Cooldown.Instance(1000, MultiAttack.Instance(25, 45*(float) Math.PI/180, 2, 0, 2)),
                    ...
                    IfEqual.Instance(-1, 4,
                        new RunBehaviors(
                            ...
                            Cooldown.Instance(2000,
                                MultiAttack.Instance(25, 45*(float) Math.PI/180, 8, 0, projectileIndex: 0)),
                            Cooldown.Instance(2000,
                                MultiAttack.Instance(25, 45*(float) Math.PI/180, 3, 0, projectileIndex: 0)),
                            Cooldown.Instance(2000, MultiAttack.Instance(25, 45*(float) Math.PI/180, 3, 0, 1)),
                            Cooldown.Instance(2000, MultiAttack.Instance(25, 45*(float) Math.PI/180, 2, 0, 2))
                            ))),
