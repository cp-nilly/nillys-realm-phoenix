...
namespace wServer.logic
{
    ...
    {
        private static _ PhoenixGod = Behav()
                ...
                new RunBehaviors(
                    ...
                    IfEqual.Instance(-1, 1,
                        new RunBehaviors(
                            ...
                            Once.Instance(
                                new SimpleTaunt("I have been summoned. Come, adventurers, and meet your despise."))
                            )
                        ),
                    IfEqual.Instance(-1, 2,
                        new RunBehaviors(
                            Once.Instance(RingAttack.Instance(24, 0, 0, 2)),
                            Flashing.Instance(100, 0xffff0000),
                            new QueuedBehavior(
                                CooldownExact.Instance(1200),
                                new SimpleTaunt(
                                    "I have been in slumber for eons to meet you, {PLAYER}. Awe at my tremendous power as I burn you down to the ashes you shall be."),
                    ...
                    IfEqual.Instance(-1, 5,
                        new RunBehaviors(
                            ...
                            Cooldown.Instance(1000,
                                MultiAttack.Instance(30, 8.5f*(float) Math.PI/360, 4, 0, projectileIndex: 0)),
                            InfiniteSpiralAttack.Instance(125, 5, 7.5f, 4),
                            UnsetConditionEffect.Instance(ConditionEffectIndex.Invulnerable),
                    ...
                    IfEqual.Instance(-1, 9,
                        new RunBehaviors(
                            ...
                            UnsetConditionEffect.Instance(ConditionEffectIndex.Invulnerable),
                            SetConditionEffect.Instance(ConditionEffectIndex.Armored),
                            InfiniteSpiralAttack.Instance(125, 3, -7.5f, 1),
                            InfiniteSpiralAttack.Instance(150, 3, 10f, 4),
                            new QueuedBehavior(
                    ...
                    IfEqual.Instance(-1, 11,
                        new RunBehaviors(
                            ...
                            Cooldown.Instance(850, MultiAttack.Instance(20, 10*(float) Math.PI/360, 5, 0, 3)),
                            Cooldown.Instance(850, MultiAttack.Instance(20, 10*(float) Math.PI/360, 4, 0, 6)),
                            new QueuedBehavior(
                                new SimpleTaunt(
                                    "Still not dead yet? I applaud your determination, but it will go no more!"),
                    ...
                    IfEqual.Instance(-1, 15,
                        new RunBehaviors(
                            ...
                            new QueuedBehavior(
                                ...
                                If.Instance(EntityLesserThan.Instance(90, 3, 0x2f67),
                                    TossEnemyAtPlayer.Instance(50, 0x2f67)),
            ...
            .Init(0x2f63, Behaves("PhoenixGodPhase1",
                new RunBehaviors(
                    ...
                    new QueuedBehavior(
                        ...
                        If.Instance(IsEntityNotPresent.Instance(25, null),
                            RingAttack.Instance(10, 0, 0, projectileIndex: 0)),
                        Despawn.Instance))
                ))
            ...
            .Init(0x2f67, Behaves("Unstable Fire Bird",
                new RunBehaviors(
                    ...
                    IfEqual.Instance(-1, 3,
                        new RunBehaviors(
                            Flashing.Instance(100, 0xff0000ff),
                            InfiniteSpiralAttack.Instance(250, 2, 24, 1),
                            new QueuedBehavior(
                    ...
                    IfEqual.Instance(-1, 4,
                        new RunBehaviors(
                            ...
                            Cooldown.Instance(900,
                                MultiAttack.Instance(20, 12.5f*(float) Math.PI/360, 5, 0, projectileIndex: 0)),
                            new QueuedBehavior(
