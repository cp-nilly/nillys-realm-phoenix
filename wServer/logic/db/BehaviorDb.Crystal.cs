            ...
            Cooldown.Instance(5000, HpLesserPercent.Instance(0.8f, new SetKey(-1, 7))), */
                    ...
                    IfEqual.Instance(-1, 1,
                        new QueuedBehavior(
                            ...
                            True.Instance(Rand.Instance(
                                new RandomTaunt(0.5, "Break the crystal for great rewards..."),
                                new RandomTaunt(0.5, "Help me...")
                                )
                                ),
                    ...
                    IfEqual.Instance(-1, 2,
                        new QueuedBehavior(
                            ...
                            True.Instance(Rand.Instance(
                                new RandomTaunt(0.5, "Fire upon this crystal with all your might for 5 seconds"),
                                new RandomTaunt(0.5, "If your attacks are weak, the crystal magically heals"),
                    ...
                    IfEqual.Instance(-1, 3,
                        new QueuedBehavior(
                            ...
                            True.Instance(Rand.Instance(
                                ...
                                new RandomTaunt(0.5, "Yes!  Smash my prison for great rewards!")
                                )
                                ),
                    ...
                    IfEqual.Instance(-1, 4,
                        new QueuedBehavior(
                            ...
                            True.Instance(Rand.Instance(
                                ...
                                new RandomTaunt(0.5, "If you are not yet powerful, stay away from the Crystal"),
                    ...
                    IfEqual.Instance(-1, 5,
                        new QueuedBehavior(
                            ...
                            True.Instance(Rand.Instance(
                                ...
                                new RandomTaunt(0.5, "Call all your friends to help you break the crystal!")
                                )
                                ),
            ...
            Flashing.Instance(150, 0x0000FF0C),*/
                ...
                loot: new LootBehavior(LootDef.Empty,
                    Tuple.Create(100, new LootDef(0, 8, 0, 8,
                        Tuple.Create(0.009, (ILoot) new ItemLoot("Crystal Wand")),
                        Tuple.Create(0.009, (ILoot) new ItemLoot("Crystal Sword")),
